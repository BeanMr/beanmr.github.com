...
(function(){
	...
	{% if site.bshare_to %}var buttonPlatforms = [{{site.bshare_to}},BSHARE_MORE];
	{% else %}var buttonPlatforms = ['bsharesync','qzone','renren','sinaminiblog','qqmb','sohuminiblog','neteasemb','kaixin001','douban',BSHARE_MORE];{% endif %}
